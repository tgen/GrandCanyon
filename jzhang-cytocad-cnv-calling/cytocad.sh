...
print_help(){
    ...
    Available arguments:
        ...
        -v  | --interval     - Spread between each point in a chromosome where coverage is enquired, in bp. 
	                       Minimum CNV sensitive detection size ~= interval x rolling, Default:50000
